...
mod implementation {
	...
	use syntect::parsing::{
		ParseState, Scope, ScopeStack, ScopeStackOp, SyntaxReference, SyntaxSet,
	};
	...
	/// Used for languages not in syntect's default set or with non-standard
	/// names.
...
mod implementation {
	...
	#[napi(js_name = "highlightCode")]
	pub fn highlight_code(code: String, _lang: Option<String>, _colors: HighlightColors) -> String {
		code
	}

	#[napi(js_name = "supportsLanguage")]
	pub fn supports_language(_lang: String) -> bool {
		false
	}
